...
<p align="center">
  <img src="docs/banner.png?v=241" alt="Claude Codex Limits — лимиты в строке меню macOS" width="820">
</p>
...
<p align="center">
  <img src="docs/menubar-dark.png?v=241" width="180" alt="Строка меню (тёмная)">
  &nbsp;&nbsp;
  <img src="docs/panel.png?v=241" width="320" alt="Панель">
</p>
...
<p align="center">
  <img src="docs/menubar-single.png?v=241" width="140" alt="Один продукт (строка меню)">
  &nbsp;&nbsp;
  <img src="docs/panel-single.png?v=241" width="300" alt="Один продукт (панель)">
</p>
<p align="center"><sub>Если настроена только одна подписка — трей и панель сворачиваются в одну строку / карточку.</sub></p>

<p align="center"><img src="docs/settings.png?v=241" width="250" alt="Экран настроек"></p>
...
<p align="center"><img src="docs/whatsnew.png?v=241" width="320" alt="Экран «Что нового»"></p>
...
1. Скачайте `ClaudeCodexLimits-2.4.1.dmg` со страницы [Releases](../../releases).
