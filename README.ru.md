...
- **Автоматические обновления** — проверка новых релизов в фоне (при запуске + каждые 6 ч); когда появляется новее, в трее и на шестерёнке ⚙ загорается точка. В настройках: **Скачать** → живой прогресс-бар → **Установить и перезапустить**. Без Sparkle и нотаризации.
...
1. Скачайте `ClaudeCodexLimits-2.0.dmg` со страницы [Releases](../../releases).
