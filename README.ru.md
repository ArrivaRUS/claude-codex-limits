...
<p align="center"><img src="docs/settings.png" width="240" alt="Экран настроек"></p>
<p align="center"><sub>Экран настроек (⚙): свой звук для каждого события — сбросы и достижение лимита.</sub></p>
...
1. Скачайте `ClaudeCodexLimits-2.2.2.dmg` со страницы [Releases](../../releases).
